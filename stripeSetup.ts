...
const plans: Plan[] = [
  {
    ...
    description: 'Perfect for small albums',
    features: ['Up to 3 albums', 'Up to 200 songs'],
  },
  {
    name: IS_PRODUCTION ? 'Pro' : 'Pro-Test',
    price: 500,
    description: 'Great for bigger albums',
    features: ['Up to 10 albums', 'Up to 1000 songs'],
  },
  {
    name: IS_PRODUCTION ? 'Enterprise' : 'Enterprise-Test',
    price: 1000,
    description: 'For large albums',
    features: ['Unlimited albums', 'Unlimited songs'],
  },
];
